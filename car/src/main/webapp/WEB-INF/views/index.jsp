...
<body class="home">
    ...
    <section class="wrapper">
        <div class="slider-wrapper">
            <div class="slider">
                ...
                <div class="slide">
                    <img src="/car/resources/images/fraction-slider/base.jpg" width="1920" height="auto" data-in="fade" data-out="fade" />

                    <img src="/car/resources/images/fraction-slider/slider-boy.png" width="600" height="600" data-position="30,1100" data-in="left" data-out="right" data-delay="700"/>
                ...
                <div class="slide">
                    <img src="/car/resources/images/fraction-slider/base_2.jpg" width="1920" height="auto" data-in="fade" data-out="fade" />

                    <img src="/car/resources/images/fraction-slider/slider-girl.png" width="600" height="545" data-position="20,400" data-in="right" data-0ut="bottom" data-delay="500"/>
                ...
                <div class="slide">
                    <img src="/car/resources/images/fraction-slider/base_3.jpg"  width="1920" height="auto" data-in="fade" data-out="fade" />
                    ...
                    <img src="/car/resources/images/fraction-slider/gadgets/laptop.png" width="456" height="272" data-position="115,1180" data-in="bottom" data-out="bottom" data-delay="400">

                    <img src="/car/resources/images/fraction-slider/gadgets/mack.png" width="357" height="313" data-position="90,1040" data-in="top" data-out="bottom" data-delay="200">

                    <img src="/car/resources/images/fraction-slider/gadgets/ipad.png" width="120" height="170" data-position="230,1030" data-in="left" data-out="left" data-delay="300">

                    <img src="/car/resources/images/fraction-slider/gadgets/smartphone.png" width="70" height="140" data-position="270,1320" data-in="right" data-out="right" data-delay="300">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-5 feature-block">
                        <img class="img-responsive center-block" src="/car/resources/images/laptop.png"/>
                    </div>
                        ...
                        <div class="carousel-inner">
                            <div class="active item">
                                <div class="parallax-testimonial-item">
                                    ...
                                    <div class="parallax-testimonial-review">
                                        <img src="/car/resources/images/testimonials/1.png" alt="testimonial">
                            ...
                            <div class="item">
                                <div class="parallax-testimonial-item">
                                    ...
                                    <div class="parallax-testimonial-review">
                                        <img src="/car/resources/images/testimonials/2.png" alt="testimonial">
                                        <span>Jonathan Dower</span>
                                        <small>Leopard</small>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="parallax-testimonial-item">
                                    ...
                                    <div class="parallax-testimonial-review">
                                        <img src="/car/resources/images/testimonials/3.png" alt="testimonial">
                                        <span>Jonathan Dower</span>
                                        <small>Leopard</small>
                                    </div>
                                </div>
        ...
        <section class="super_sub_content">
            ...
            <div class="portfolio-centered">
                <div class="recentitems portfolio">
                    ...
                    <div class="portfolio-item web-design mockups">
                        <div class="box">
                            <img src="/car/resources/images/portfolio/portfolio_10.png" alt="">
                            <div class="option inner">
                                <div>
        ...
        <div class="super_sub_content">
            <div class="container">
                <div class="row">
                    <div class="col-sm-7">
                        <img class="img-responsive center-block" src="/car/resources/images/imac.png"/>
                    </div>
        ...
        <div class="super_sub_content grey_bg">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img src="/car/resources/images/phones.png" class="img-responsive center-block">
                    </div>
    ...
    <script type="text/javascript" src="/car/resources/js/jquery-1.10.2.min.js"></script>
    ...
    <script type="text/javascript" src="/car/resources/js/jquery.cookie.js"></script> <!-- jQuery cookie -->
    <script type="text/javascript" src="/car/resources/js/styleswitch.js"></script> <!-- Style Colors Switcher -->
    <script src="/car/resources/js/jquery.fractionslider.js" type="text/javascript" charset="utf-8"></script>
    <script type="text/javascript" src="/car/resources/js/jquery.smartmenus.min.js"></script>
    <script type="text/javascript" src="/car/resources/js/jquery.smartmenus.bootstrap.min.js"></script>
    <script type="text/javascript" src="/car/resources/js/owl.carousel.min.js"></script>
    <script type="text/javascript" src="/car/resources/js/jflickrfeed.js"></script>
    <script type="text/javascript" src="/car/resources/js/jquery.magnific-popup.min.js"></script>
    <script type="text/javascript" src="/car/resources/js/jquery.isotope.min.js"></script>
    <script type="text/javascript" src="/car/resources/js/jquery.easypiechart.min.js"></script>
    <script type="text/javascript" src="/car/resources/js/swipe.js"></script>
    <script type="text/javascript" src="/car/resources/js/jquery-hoverdirection.min.js"></script>
    <script type="text/javascript" src="/car/resources/js/jquery.matchHeight-min.js"></script>
    <script type="text/javascript" src="/car/resources/js/jquery-scrolltofixed-min.js"></script>
