		...
		$('#view-schedule')
				.on(
						...
						function(event) {
							...
							$
									.ajax(
											"/car/groupschedule/view.action?scheduleNo=17",
											{

												success : function(data) {

													eval("var groupSchedule = "
															+ data);

													document
															.getElementById("title2").value = groupSchedule.title;
													document
															.getElementById("start-date2").value = groupSchedule.startDate;
													document
															.getElementById("end-date2").value = groupSchedule.endDate;
													document
															.getElementById("depart-time2").value = groupSchedule.departTime;
													document
															.getElementById("content2").value = groupSchedule.content;
								...
								<table class="table table-borderd"
									...
									<tr>
										<td>
											...
											<form id="joinChatForm" action="/car/mvc/chat"
												th:action="@{/mvc/chat}"
												data-bind="visible: activePollingXhr() == null">
												<p>
													<label for="user">User Nick Name: </label> <input id="user"
														name="user" type="text" data-bind="value: userName" /> <input
														name="messageIndex" type="hidden"
														data-bind="value: messageIndex" />
													<button id="start" type="submit"
														data-bind="click: joinChat">Join Chat</button>
												</p>
											</form>

											<form id="leaveChatForm" action="/car/mvc/chat"
												th:action="@{/mvc/chat}"
												data-bind="visible: activePollingXhr() != null">
												<p>
													You're chatting as <strong data-bind="text: userName"></strong>
													<button id="leave" type="submit"
														data-bind="click: leaveChat">Leave Chat</button>
												</p>
											</form>
											...
											<form id="postMessageForm" action="/car/mvc/chat"
												th:action="@{/mvc/chat}"
												data-bind="visible: activePollingXhr() != null">
												<p>
													...
													<button id="post" type="submit"
														data-bind="click: postMessage">Post</button>
												</p>
											</form>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<form role="form">
													...
													<div class="form-group">
														<label for="startDate">Start Date</label> <input
															type="text" class="form-control" id="start-date2"
															readonly></input>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														<label for="departTime">Depart Time</label> <input
															type="text" class="form-control" id="depart-time2"
															readonly></input>
													</div>
													<div class="form-group">
														<label for="content">Content</label> <input type="text"
...
<script type="text/javascript"
	src="/car/resources/js/jquery-1.7.2.min.js"
	th:src="@{/car/resources/js/jquery-1.7.2.min.js}"></script>
<script type="text/javascript" src="/car/resources/js/knockout-2.0.0.js"
	th:src="@{/car/resources/js/knockout-2.0.0.js}"></script>
<script type="text/javascript" src="/car/resources/js/chat.js"
	th:src="@{/car/resources/js/chat.js}"></script>
