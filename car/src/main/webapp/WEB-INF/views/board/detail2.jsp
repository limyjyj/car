		...
		<div id="inputcontent">
		    <div id="inputmain">
		      ...
		      <div>
		        	...
		        	<div>
		        		<input type="button" value="수정" style="height: 40px" onclick="location.href='edit2.action?boardNo=${ board.boardNo }';"/> 
		        	</div>
		        	<div>
		        		<input type="button" value="목록보기" style="height: 40px" onclick="location.href='list2.action';"/> 
		        	</div>
		   		</div>
		      </div> 
		     </div>
