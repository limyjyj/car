...
<body>
	...
	<div id="inputcontent"
		...
		<div id="inputmain">
			...
			<br />
			<form:form method="post" modelAttribute="board" action="update.action"> <!-- 상대경로표시 -->
				...
				<table style="text-align:center; margin: auto;" class="type11">
					...
					<tr>
						...
						<td><fmt:formatDate value="${ board.regDate }" pattern="yyyy-MM-dd" var="regDate" /> ${ regDate }</td>
					</tr>
					<tr>
						...
						<input type="hidden" value="${ board.boardNo }" name="boardNo" /></td>
					</tr>
				...
				<div style="text-align: center">
					...
					<input id="cancel" class="button" value="취소"
